    ...
    <div className="mx-auto w-full max-w-5xl space-y-5">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="grid w-full grid-cols-2 gap-2 sm:flex sm:w-auto">
          <Link href={`/dashboard/members/${encodeURIComponent(member.memberId)}/attendance`} className="col-span-2 rounded-lg border border-blue-200 bg-blue-50 px-4 py-2.5 text-center text-sm font-semibold text-blue-700 shadow-sm hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:col-span-1">
