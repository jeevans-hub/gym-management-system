  ...
  return (
    <div className="flex flex-col gap-3 border-t border-gray-200 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-5">
      <p className="text-sm text-gray-500">
        {total === 0 ? 'No trainers to show' : `Showing ${firstRecord}–${lastRecord} of ${total} trainers`}
      </p>
      <div className="flex items-center justify-between gap-3 sm:justify-end">
        <button
          ...
          className="rounded-lg border border-gray-300 bg-white px-3.5 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-40"
        >
          Previous
        </button>
